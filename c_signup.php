...
<div class="app">
  <section id="login-page">
    <div class="container">
      <div class="center">
        <h2>Need Audience for your show? Sign up!</h2>
      ...
      <div class="row contact-wrap">
        ...
        <div class="col-md-4 col-md-offset-4">
          ...
          <form id="regForm" action="data/signup_c.php" method="post" role="form" class="contactForm">
          ...
          <div class="float-right text-center">
            <a href="register.php" class="btn">DO YOU WANT TO BUY TICKETS?</a>
            </div>
        </div>
      </div>
      <!--/.row-->
